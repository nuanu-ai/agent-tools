---
name: bpmn-processes
description: Author and operate Nuanu Flow processes (BPMN workflows) — build the node/edge graph with human tasks, AI agent tasks, decisions, and gateways; validate and activate templates; trigger runs; complete tasks and submit decisions.
---
