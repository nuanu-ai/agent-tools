---
name: artifacts
description: Store, version, search, and link files and documents in the Nuanu Flow artifact registry — research outputs, reports, datasets; temp scratch vs committed storage, logical folders, entity binding, and presigned downloads.
---
