...
description: Onboard a new Nuanu Flow workspace from a business brief — capture the company context, write the company wiki page, define objectives with dated milestones, and optionally invite the team. Scaffolding individual projects is the separate project-setup skill.
---

# Workspace setup

This skill enriches a workspace that already exists. It does not create a
workspace. For a first workspace, a new account, or zero workspaces, use the
`onboarding` skill first.
